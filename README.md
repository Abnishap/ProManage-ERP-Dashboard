...
This app displays a modern dashboard with KPI cards and navigation. It includes pages for inventory, projects, resources, reports, and tasks with support for team roles, project workflows, and task status tracking.
...
### Extending the App
- To add new pages, put them under `src/` and add navigation links in the header/sidebar
- To update data, edit `backend/data.js` and/or `src/data/mockData.js`
- The app is designed to be easy to run locally and straightforward to extend with new dashboard sections
